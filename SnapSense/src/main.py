    ...
    while True:
        ...
        if last_recognized_word:
            ...
            #     last_audio_command = last_recognized_word
                ...
                last_audio_command = last_recognized_word
            # elif "black" in last_recognized_word:
            #     canvas.set_colour(Colours.BLACK.name)
            #     ui_manager.set_colour(Colours.BLACK.name)
            #     last_audio_command = last_recognized_word
            elif "orange" in last_recognized_word:
                canvas.set_colour(Colours.ORANGE.name)
                ui_manager.set_colour(Colours.ORANGE.name)
                last_audio_command = last_recognized_word
